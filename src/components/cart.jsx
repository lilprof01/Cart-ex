    ...
    <div className="flex flex-col justify-between align-middle lg:max-h-full w-4/6 bg-white rounded-lg p-5 shadow-md">
      ...
      {totalCount === 0 ? (
        <>
          ...
          <div className="mx-auto">Your added items will appear here</div>
        </>
      ) : (
        <>
          ...
          <div className="bg-[#fcf9f7] px-5 py-2 my-8 rounded-lg text-center w-full flex gap-2 justify-center items-center align-middle">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
